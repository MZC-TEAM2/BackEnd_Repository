...
('과제질문', '과제질문', '#1976d2', 'QUESTION', 1, 20241001, NOW()),
('시험준비', '시험준비', '#9c27b0', 'QUESTION', 1, 20241001, NOW()),
('개념이해', '개념이해', '#0288d1', 'QUESTION', 1, 20241001, NOW()),
('문제풀이', '문제풀이', '#388e3c', 'QUESTION', 1, 20241001, NOW()),
('학습자료', '학습자료', '#f57c00', 'QUESTION', 1, 20241001, NOW()),
('프로젝트', '프로젝트', '#d32f2f', 'QUESTION', 1, 20241001, NOW()),
('실습질문', '실습질문', '#1976d2', 'QUESTION', 1, 20241001, NOW()),
