...
CREATE TABLE IF NOT EXISTS `courses` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci AUTO_INCREMENT=49;
...
CREATE TABLE IF NOT EXISTS `course_carts` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci AUTO_INCREMENT=134;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci AUTO_INCREMENT=71;
...
CREATE TABLE IF NOT EXISTS `enrollment_periods` (
  ...
  `created_at` timestamp NULL DEFAULT (now()) COMMENT '생성 일시',
  PRIMARY KEY (`id`),
  KEY `idx_enrollment_periods_period_type_id` (`period_type_id`),
  KEY `idx_enrollment_periods_type_datetime` (`period_type_id`,`start_datetime`,`end_datetime`),
  CONSTRAINT `fk_enrollment_periods_period_type` FOREIGN KEY (`period_type_id`) REFERENCES `period_types` (`id`)
...
CREATE TABLE IF NOT EXISTS `subjects` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci AUTO_INCREMENT=62;
