...
CREATE TABLE IF NOT EXISTS    `academic_terms` (
  `id` bigint NOT NULL COMMENT '학기 식별자',
...
CREATE TABLE IF NOT EXISTS   `courses` (
  `id` bigint NOT NULL COMMENT '강의 식별자',
...
CREATE TABLE IF NOT EXISTS   `course_carts` (
  `id` bigint NOT NULL COMMENT '장바구니 항목 식별자',
...
CREATE TABLE IF NOT EXISTS   `course_schedules` (
  `schedule_id` bigint NOT NULL COMMENT '시간표 식별자',
  `course_id` bigint NOT NULL COMMENT '강의 ID',
...
CREATE TABLE IF NOT EXISTS   `course_status_types` (
  `id` int NOT NULL COMMENT '상태 식별자',
...
CREATE TABLE IF NOT EXISTS   `course_types` (
  `id` int NOT NULL COMMENT '유형 식별자',
...
CREATE TABLE IF NOT EXISTS   `course_weeks` (
  `id` bigint NOT NULL COMMENT '주차 식별자',
  `course_id` bigint NOT NULL COMMENT '강의 ID',
...
CREATE TABLE IF NOT EXISTS   `enrollments` (
  `id` bigint NOT NULL COMMENT '수강신청 식별자',
  `course_id` bigint NOT NULL COMMENT '강의 ID',
  `student_id` bigint NOT NULL COMMENT '학생 ID',
...
CREATE TABLE IF NOT EXISTS   `period_types` (
  `id` int NOT NULL COMMENT '기간 타입 식별자',
...
CREATE TABLE IF NOT EXISTS   `subjects` (
  `id` bigint NOT NULL COMMENT '과목 식별자',
...
CREATE TABLE IF NOT EXISTS   `subject_prerequisites` (
  `id` bigint NOT NULL COMMENT '관계 식별자',
  `subject_id` bigint NOT NULL COMMENT '과목 ID',
